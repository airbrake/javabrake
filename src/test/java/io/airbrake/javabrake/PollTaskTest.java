...
public class PollTaskTest {
  ...
  public void testPollTaskEmptyBody() {
    ...
    String url = "/some/thing/2020-06-18/config/0/config.json?os="
        + NOTIFIER_INFO.get("os").replaceAll("/", "%2F").replaceAll(" ", "%20") +
        "&notifier_version=" + NOTIFIER_INFO.get("notifier_version") + "&language="
        + NOTIFIER_INFO.get("language").replaceAll("/", "%2F").replaceAll(" ", "%20") + "&notifier_name="
